// ref 1 = https://minimalanalytics.com/
// ref 2 = https://gist.github.com/DavidKuennen/443121e692175d6fc145e1efb0284ec9
var host = window.location.hostname;
console.log ("host = "+host);
if( host == "localhost" || host == "127.0.0.1") {
  console.log ("GA record no");
} else {
  console.log ("host = "+host);
